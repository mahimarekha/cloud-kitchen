            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={4} sm={6}>
                <TextField InputProps={{ style: { width: 370 } }}
                  ...
                  onChange={formik.handleChange}
                  error={formik.touched.fullName && Boolean(formik.errors.fullName)}  helperText={formik.touched.fullName && formik.errors.fullName}
                />
              </Grid>
              <Grid item xs={12} md={4} sm={6}>
                <TextField InputProps={{ style: { width: 370 } }}
                  ...
                  onChange={formik.handleChange}
                  error={formik.touched.mobileNumber && Boolean(formik.errors.mobileNumber)} helperText={formik.touched.mobileNumber && formik.errors.mobileNumber}
                />
              </Grid>
              <Grid item xs={12} md={4} sm={6}>
                <TextField InputProps={{ style: { width: 370 } }}
